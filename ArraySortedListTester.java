 ...
 */
public class ArraySortedListTester {
    ...
    public static void testForIntegers() {
        ...
        ArraySortedList<Integer> sortedList = new ArraySortedList<>();
        ...
        Comparable[] actualArray_1 = sortedList.toArray();
        ...
        Comparable[] actualArray_2 = sortedList.toArray();
        ...
        Comparable[] actualArray_21 = sortedList.toArray();
        ...
        Comparable[] actual_array_6 = sortedList.toArray();
        ...
        Comparable[] actual_array_9 = sortedList.toArray();
    ...
    public static void testForStrings() {
        // Create a new ArrayListSortedList
        ArraySortedList<String> sortedList = new ArraySortedList<>();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------------------------\n");
        System.out.println("Your final score for ArraySortedList (out of 50 points) = " + (total_points * 2.5));
