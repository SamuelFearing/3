...
/**
 * LinkedListSortedListTester is a tester class for testing LinkedListSortedList
 ...
 */
public class LinkedListSortedListTester {
    ...
    public static void testForIntegers() {
        ...
        LinkedListSortedList<Integer> sortedList = new LinkedListSortedList<>();
    ...
    public static void testForStrings() {
        // Create a new ArrayListSortedList
        LinkedListSortedList<String> sortedList = new LinkedListSortedList<>();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------------------------\n");
        System.out.println("Your final score for LinkedListSortedList (out of 50 points) = " + (total_points * 2.5));
